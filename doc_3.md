...
The createNode function creates a new node with the given value and initializes its next pointer to NULL. The insertEnd function adds a new node at the end of the linked list. It traverses the list until the last node and links the new node.
